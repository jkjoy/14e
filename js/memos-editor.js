...
var editIcon = "<div class='load-memos-editor'>说说</div>";
var memosEditorCont = `
    ...
    <div id="memos-tag-menu"></div>
      ...
      <div class="memos-editor-footer border-t pt-3 mt-3">
        ...
        <div class="primary edit-memos-btn px-3 py-2">修改完成</div>
          ...
          <div class="primary submit-memos-btn px-3 py-1">发送说说</div>
        </div>
      </div>
    </div>
